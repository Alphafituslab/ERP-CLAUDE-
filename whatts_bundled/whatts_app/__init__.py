...
# Fase 123 (Parte 2) — cópia vendorizada dentro do AlphafitusOS
# (whatts_bundled/), layout achatado (whatts_app/ e frontend/ são
# irmãos direto sob whatts_bundled/, sem a pasta "backend/" extra do
# projeto original) — por isso um dirname() a menos que o original.
